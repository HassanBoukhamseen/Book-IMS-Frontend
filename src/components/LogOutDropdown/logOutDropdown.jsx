    ...
    return (
        <div id={styles["logout-options"]} style={{"display": props.logOutDropdownDisplay}}>
            <div id={styles["logout-options-list"]}>
                <li onClick={() => props.setLoggedIn(false)} className={styles["logout-options-element"]}>
                    <svg id={styles["logout-icon"]} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M15.791 12.75H3.75C3.336 12.75 3 12.414 3 12C3 11.586 3.336 11.25 3.75 11.25H15.791C16.205 11.25 16.541 11.586 16.541 12C16.541 12.414 16.205 12.75 15.791 12.75Z" fill="red"/>
