...
const AdminBook = ({ title, genre, author, year, rating, description }) => {
    return (
        <div className={styles.bookRow}>
            ...
            <div className={styles.bookCell}>{year}</div>
            <div className={styles.bookCell}>{process(description)}</div>
            <div className={styles.bookCell}>{rating}</div>
        </div>
    );
};
