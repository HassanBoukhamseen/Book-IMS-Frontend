...
function displayResults(setDisplayType, setCurrentPage) {
    ...
    return (
        <div id={styles["search-bar"]}>
            <div id={styles["search-field"]}>
                <svg id={styles["search-icon"]} onClick={() => displayResults(props.setDisplayType, props.setCurrentPage)}xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" className="hover">
                ...
                <input 
                    ...
                    onChange={(e) => {props.setSearchInput(e.target.value); displayResults(props.setDisplayType, props.setCurrentPage)} }
                    className="hover" 
